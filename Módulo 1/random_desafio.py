'''
 Desafio 1: Você quer simular a opção de jogar uma moeda e resultar em cara ou coroa
...
'''
 Desafio 2: Você quer fazer um sorteio entre 5 nomes em uma lista de nomes. 
...
'''
 Desafio 3: Você quer escolher aleatóriamente um número de 10 à 100. 
